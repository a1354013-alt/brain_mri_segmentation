"""
Visualization utilities with Alpha Blending and MC Dropout (v3.0 Final Release Gold Master)
"""
...
def enable_dropout(model: nn.Module) -> None:
    """
    只將 nn.Dropout 與 nn.Dropout2d 設為 train 模式 (v3.0 Final)
    """
...
def plot_results_with_uncertainty(
    ...
    """
    視覺化結果：原圖、GT、預測、不確定性、疊加圖 (v3.0 Final)
    """
    ...
    # Overlay (v3.0 Final Alpha Blending)
