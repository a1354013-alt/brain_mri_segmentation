"""
Main CLI for Brain MRI Segmentation Project (v3.1 Final Release Gold Master)
"""
...
def train_command(args):
    ...
    # v3.1 Final 實作快取共享子集化，並傳入對應的 output_dir
...
def demo_command(args):
    ...
    trainer = Trainer(
        ...
        tensorboard_dir=config.DEMO_TENSORBOARD_DIR,
        use_amp=False,
        total_epochs=1,
    )
    trainer.train()
...
def main():
    parser = argparse.ArgumentParser(description="Brain MRI Segmentation (v3.1 Final Release Gold Master)")
